...
import Data.Expenses.Parse.Megaparsec.Entry (Entry, entryCategories, entryDate, entryPrice, entryRemark)
...
recordFromEntry entry =
  [date, price, cur, remark] ++ map show (entryCategories entry)
  where
